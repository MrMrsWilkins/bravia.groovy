...
standardTile("Social", "device.switch", inactiveLabel: false, height: 1, width: 1, decoration: "flat") {
   state "default", label:"Social", action:"Social", icon:""
	...
	details(["switch", "digital", "picoff", "tv_source", "hdmi1", "hdmi2", "hdmi3", "hdmi4", "Netflix", "Digital", "home", "mute", "refresh", "gguide", "epg", "favorites", "display", "options", "retu", "up", "down", "right", "left", "confirm", "Forward", "Play", "Rewind", "Prev", "Stop", "Next", "Rec", "Pause", "Eject", "volumeup", "volumedown", "ChannelUp", "ChannelDown",
